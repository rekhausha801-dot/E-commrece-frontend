...
.premium-logo-r {
  ...
  font-weight: 800;
  background: linear-gradient(135deg, #FFDF73 0%, #C89953 50%, #8A6327 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  text-shadow: 0 0 30px rgba(200, 153, 83, 0.8);
  z-index: 2;
  line-height: 1;
}
...
.premium-logo-ring {
  ...
  border-top-color: #FFDF73;
  border-bottom-color: #C89953;
  border-radius: 50%;
  animation: spinRing 4s linear infinite;
  box-shadow: 0 0 25px rgba(255, 223, 115, 0.4) inset, 0 0 25px rgba(200, 153, 83, 0.5);
}

.premium-logo-ring::before {
  content: '';
  position: absolute;
...
.welcome-text {
  ...
  margin: 0 0 12px 0;
  letter-spacing: 2px;
  background: linear-gradient(90deg, #FFFFFF, #FFDF73, #FFFFFF);
...
console.log("WelcomeScreen.css updated");
